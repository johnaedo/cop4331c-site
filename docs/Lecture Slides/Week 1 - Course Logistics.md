...
---
## Suggested Roles
- **Project manager** – coordinates work across roles, develops project timeline, enables communication/collaboration.  Also takes on a secondary development role.  "Not just a backseat driver"
- **Database** – creates the entity relationship diagram (ERD) for the team, which becomes part of the presentation
