...
> [!FILE DOWNLOAD]
> You can download the SQL scripts to your PC here:  [sql-scripts.zip](https://teaching.johnaedo.com/code/cop4331c/lamp/sql-scripts.zip)
...
```bash
curl -O https://teaching.johnaedo.com/code/cop4331c/lamp/sql-scripts.zip
```
